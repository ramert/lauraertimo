<template>
    <div class="book" :class="{'book--link': isLink}">
      ...
      <div>
        <h2 class="book__link h3" :class="{'book__link--underline': isLink}">{{name}}</h2>
        <div>
...
export default {
  name: "book",
  props: ["name", "isLink", "image", "altText", "publisher", "publisherLink", "illustrator", "description", "loadingColor", "flag"],
  methods: {
    routeTransition() {
